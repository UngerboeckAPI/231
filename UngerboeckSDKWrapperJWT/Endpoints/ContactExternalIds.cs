...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class ContactExternalIds : Base<ContactExternalIdsModel>
  {
    protected internal ContactExternalIds(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<ContactExternalIdsModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public ContactExternalIdsModel Get(int id, Ungerboeck.Api.Models.Options.Subjects.ContactExternalIds options = null)
    {
    ...
    public ContactExternalIdsModel Add(ContactExternalIdsModel model, Ungerboeck.Api.Models.Options.Subjects.ContactExternalIds options = null)
    {
    ...
    public HttpResponseMessage Delete(int id, Ungerboeck.Api.Models.Options.Subjects.ContactExternalIds options = null)
    {
